                ...
                <tbody>
                    ...
                    <?php foreach ($pacientes as $row) { ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><a href="<?= base_url('odontograma/odontograma_view/' . $row->codi_pac . '/0') ?>"><button id="btn_ov_<?= $row->codi_pac ?>" type="button" class="btn btn-primary" >Ver Odontograma</button></a></td>
                        </tr>
