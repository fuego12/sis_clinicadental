                ...
                <div class="btn-group" style="margin:1%">
                    ...
                    <?php if ($i + 1 <= 16) { ?>
                        ...
                        <div>
                            <div style="width:36px">
                                ...
                                <div class="<?= $diente ?>_1" id="v" style="float:left;width:12px;height:12px;border: 1px solid #cccccc"></div>
                                <div style="float:left;width:12px;height:12px;border: 1px solid #ffffff"></div>
                            </div>
                            <div style="width:36px">
                                <div class="<?= $diente ?>_4" id="m" style="float:left;width:12px;height:12px;border: 1px solid #cccccc"></div>
                                <div class="<?= $diente ?>_5" id="<?php if($i > 4 && $i < 11){ echo 'i'; } else { echo 'o'; } ?>" style="float:left;width:12px;height:12px;border: 1px solid #cccccc"></div>
                                <div class="<?= $diente ?>_2" id="d" style="float:left;width:12px;height:12px;border: 1px solid #cccccc"></div>
                            </div>
                            <div style="width:36px">
                                <div style="float:left;width:12px;height:12px;border: 1px solid #ffffff"></div>
                                <div class="<?= $diente ?>_3" id="p" style="float:left;width:12px;height:12px;border: 1px solid #cccccc"></div>
                                <div style="float:left;width:12px;height:12px;border: 1px solid #ffffff"></div>
                            </div>
                    ...
                    <?php } else { ?>
                        ...
                        <div>
                            ...
                            <div style="width:36px">
                                <div style="float:left;width:12px;height:12px;border: 1px solid #ffffff"></div>
                                <div class="<?= $diente ?>_1" id="v" class="<?= $diente ?>" style="float:left;width:12px;height:12px;border: 1px solid #cccccc"></div>
                                <div style="float:left;width:12px;height:12px;border: 1px solid #ffffff"></div>
                            </div>
                            <div style="width:36px">
                                <div class="<?= $diente ?>_4" id="m" style="float:left;width:12px;height:12px;border: 1px solid #cccccc"></div>
                                <div class="<?= $diente ?>_5" id="<?php if($i > 20 && $i < 27){ echo 'i'; } else { echo 'o'; } ?>" style="float:left;width:12px;height:12px;border: 1px solid #cccccc"></div>
                                <div class="<?= $diente ?>_2" id="d" style="float:left;width:12px;height:12px;border: 1px solid #cccccc"></div>
                            </div>
                            <div style="width:36px">
                                <div style="float:left;width:12px;height:12px;border: 1px solid #ffffff"></div>
                                <div class="<?= $diente ?>_3" id="l" style="float:left;width:12px;height:12px;border: 1px solid #cccccc"></div>
                                <div style="float:left;width:12px;height:12px;border: 1px solid #ffffff"></div>
                            </div>                            
                        </div><br><br><br>
    ...
    <div class="panel-body">
        ...
        <form class="form-inline" id="frmEstadoDiente" action="<?= base_url('update_diente_estado') ?>" method="post">
            ...
            <div class="form-group">
                ...
                <label> Estado &nbsp; </label><select style="width:13%" class="form-control form-control" id="codi_edi" name="codi_edi"> <?php foreach ($estado_diente as $row) { ?> <option value="<?= $row->codi_edi ?>"> <?= $row->titu_edi . ' = ' . $row->nomb_edi ?> </option> <?php } ?> </select>
                <div class="checkbox">
                    <label><input id="completo" name="completo" type="checkbox"> Pieza completa </label>
                    <label><input id="mesial" name="mesial" type="checkbox"> Mesial </label>
                    <label><input id="distal" name="distal" type="checkbox"> Distal </label>
                    <label><input id="oclusal" name="oclusal" type="checkbox"> Oclusal </label>
                    <label><input id="incisal" name="incisal" type="checkbox"> Incisal </label>
                    <label><input id="palatino" name="palatino" type="checkbox"> Palatino </label>
                    <label><input id="lingual" name="lingual" type="checkbox"> Lingual </label>
                    <label><input id="vestibular" name="vestibular" type="checkbox"> Vestibular </label>
                </div>
    ...
    <div class="panel-body">
        <form class="form-inline" id="frmEnfermedadDiente" action="<?= base_url('update_diente_enfermedad') ?>" method="post">
            ...
            <div class="form-group">
                ...
                <label> Enfermedad &nbsp; </label><select style="width:35%" class="form-control form-control" name="codi_enf"> <?php foreach ($enfermedad as $row) { ?> <option value="<?= $row->codi_enf ?>"> <?= $row->titu_enf . ' - ' . $row->desc_enf ?> </option> <?php } ?> </select>
                <input type="hidden" id="codi_pac" name="codi_pac" value="<?= $paciente->codi_pac ?>">
                <input type="hidden" id="codi_pac" name="codi_cit" value="<?= $codi_cit ?>">
